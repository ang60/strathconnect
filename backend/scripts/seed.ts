  ...
  const programs = [
    {
      ...
      mentors: [users.find(u => u.email === 'john.doe@example.com')?._id],
  ...
  const goals = [
    {
      ...
      progress: 60,
      mentee: users.find(u => u.email === 'mike.johnson@example.com')?._id,
      mentor: users.find(u => u.email === 'john.doe@example.com')?._id,
